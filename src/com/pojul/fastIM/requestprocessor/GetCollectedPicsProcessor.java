...
public class GetCollectedPicsProcessor implements RequestProcessor{

	@Override
	public void process(RequestMessage request, ClientSocket clientSocket) {
		// TODO Auto-generated method stub
		GetCollectedPicsReq req = (GetCollectedPicsReq) request;
		GetCollectedPicsResp response = new GetCollectedPicsResp();
		...
		List<SimpleUploadPic> simpleUploadPics = new UploadPicDao().getCollectedPics(req.getGallery(), req.getNum(), req.getStartNum(), req.getFrom(), req.getUserId());
