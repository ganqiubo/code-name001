...
public class SocketRequest {
    ...
    public void request(ClientSocket mClientSocket, BaseMessage message, final IRequest mIRequest){
        request(mClientSocket, message, mIRequest, defaultTimeOut);
    }

    public void request(ClientSocket mClientSocket, BaseMessage message, final IRequest mIRequest, long timeout){
